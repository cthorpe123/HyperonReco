...
double FittedV::GetAsymmetry() const { 

  return (double)std::max(Arm1Points,Arm2Points)/(Arm1Points+Arm2Points);

}

//////////////////////////////////////////////////////////////////////////////////////////////////////////////

double FittedV::GetOpeningAngle() const { 

  return GetArm1Dir().Angle(GetArm2Dir());
